...
if page == "Introduction":
    ...
    st.subheader("Citing: ")
    st.write("""Zhilong Wang, Fengqi You*, A dynamic routing-guided interpretable framework for salt–solvent chemistry. Nature Computational Science (2026) https://doi.org/10.1038/s43588-026-00955-5""")
